...
namespace FirmyMichalowice.Migrations
{
    ...
    [Migration("20220311114247_addUserSettings")]
            ...
            modelBuilder.Entity("FirmyMichalowice.Model.UserSettings", b =>
                {
                    ...
                    b.Property<bool>("UsingActiveLink")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("UsingGoggleMaps")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("FirmyMichalowice.Model.UserSettings", b =>
                {
                    b.HasOne("FirmyMichalowice.Model.User", "User")
                        ...
                        .HasForeignKey("FirmyMichalowice.Model.UserSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
